	...
	)
{
	...
	const float4 reflectionValue = materialConstant + ((1-materialConstant) * (1- pow((dot(normalizedNormal, reflectedCameraVector)), 5)));
	...
	const float4 diffuseOutput = (g_material_color + reflectionValue);
